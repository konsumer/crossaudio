...
export class Spectrograph extends AnalyserNode {
  constructor (audioContext, canvas, backgroundColor = 'transparent', palette = defaultPallette, maxDecibels = -25, minDecibels = -60, smoothingTimeConstant = 0.5, fftSize = 2048) {
  ...
  start () {
    ...
    const draw = () => {
      ...
      for (const d of this.data) {
        console.log(d, this.colormap(2 / 255))
      }
    }
    draw()
  }
